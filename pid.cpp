...
std::string getConnectInfo()
{
    ...
    if ((dwRetVal = GetTcpTable2(pTcpTable, &ulSize, TRUE)) == NO_ERROR) {
		std::string header = "PID\tLocal\t\t\tRemote\t\t\tProcess\t\t\tCommandLine\n";
		std::stringstream lineConnection;


		lineConnection << header;
		...
		std::string szlineConnection = lineConnection.str();
		//cout << szlineConnection;
		return szlineConnection;
